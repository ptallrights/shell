...
#* Author: GuoShaoGang
#* Date: 2015-10-01
#* Email: m18829289189@163.com
#* Describe: This is a shell script
#* Filename: lnmp9.sh
#******************
...
mysql(){
	...
	${mysql_pwd}/scripts/./mysql_install_db --user=mysql --basedir=${mysql_pwd} --datadir=${mysql_pwd}/data/ &>/dev/null
	echo -e "\033[32m    Mysql is installing
    ###############[90%] \033[0m"
	mysql_node=0
...
third_list() {
     ...
     echo -e "\033[36m   r   remove \033[0m"
     echo -e "\033[36m   bs  back Second Menu \033[0m"
     echo -e "\033[36m   bf  back First Menu \033[0m"
     echo -e "\033[36m   e   exit \033[0m"
     echo   "  ###################"
}
third_opt() {
...
second_list() {
    echo -e "  ### \033[36m Second Menu \033[0m### "
     [ "$nginx_node" = "0" ] && echo -e "\033[31m   n nginx \033[0m"       
     [ "$mysql_node" = "0" ] && echo -e "\033[32m   m nginx \033[0m" 
     [ "$php_node" = "0" ] && echo -e "\033[33m   p php   \033[0m"
    echo -e "\033[36m   b back First Menu \033[0m"
    echo -e "\033[36m   e exit \033[0m"
    echo "  ################### "
...
if [ "$nginx_node" != "0" -a "$mysql_node" != "0" -a "$php_node" != "0" ];then
	...
	if [ "$n" == "yes" ];then
		...
		echo -e "\033[36m noting is installed \033[0m"
		exit
	fi
