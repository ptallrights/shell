...
lvcreate -L 400M -n database datestore
...
authconfig --enableldap --enableldaptls --enablekrb5 --ldaploadcacert=http://172.25.254.112/example-ca.crt --ldapserver=classrppm.example.com --ldapbasedn="dc=example,dc=com" --krb5kdc=classroom.example.com --krb5adminserver=classroom.example.com --krb5realm=EXAMPLE.COM --updateall
